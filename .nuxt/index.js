...
import nuxt_plugin_plugin_6f589ac8 from 'nuxt_plugin_plugin_6f589ac8' // Source: .\\components\\plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"titleTemplate":"Mastering Nuxt: %s","htmlAttrs":{"lang":"en"},"bodyAttrs":{"class":["body-styles"]},"meta":[{"charset":"utf-8"}],"link":[],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_6f589ac8 === 'function') {
    await nuxt_plugin_plugin_6f589ac8(app.context, inject)
  }
