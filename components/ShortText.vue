<template>
  <div>
    {{ displayText }}<br>
    <button v-if="isTooLong && !isExpanded" @click="isExpanded = true" type="button">read more</button>
    <button v-if="isTooLong && isExpanded" @click="isExpanded = false" type="button">read less</button>
  </div>
</template>
